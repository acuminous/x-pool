...
const NullPartition = require('./partitions/NullPartition');
...
class Queue {
  ...
  #partitions = {
    queued: new Partition('queued'),
    dispatched: new Partition('dispatched'),
    fulfilled: new NullPartition('fulfilled'),
    aborted: new NullPartition('aborted'),
  };
