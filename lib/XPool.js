...
class XPool extends SafeEventEmitter {
  ...
  #addEventListeners() {
    this.#eventListeners.add(XPoolEvents.RESOURCE_RELEASED, () => this.#checkQueue());
    this.#eventListeners.add(XPoolEvents.RESOURCE_DESTROYED, () => this.#checkQueue());
  ...
  #replaceEventListeners() {
    ...
    this.#eventListeners.add(XPoolEvents.RESOURCE_RELEASED, () => this.#repository.cull(this.#stopOperation));
    this.#eventListeners.add(XPoolEvents.RESOURCE_DESTROYED, () => this.#checkStop());
  }
}
