...
class XPool extends SafeEventEmitter {
  ...
  #createRepository() {
    const { minPoolSize, maxPoolSize, minIdleResources, validate } = this.#config;
    const repository = new Repository({ minPoolSize, maxPoolSize, minIdleResources, validate }, this.#createCommandFactory());
