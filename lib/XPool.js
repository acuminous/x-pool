...
class XPool extends SafeEventEmitter {
  ...
  constructor(config) {
    ...
    this.on(XPoolEvents.RESOURCE_RELEASED, () => this.#checkQueue());
    this.on(XPoolEvents.RESOURCE_RELEASED, () => this.#checkStop());
    this.on(XPoolEvents.RESOURCE_DESTROYED, () => this.#checkQueue());
    this.on(XPoolEvents.RESOURCE_DESTROYED, () => this.#checkStop());
  }
  ...
  async #stopGracefully() {
    ...
    this.#repository.cull(this.#stopOperation);
