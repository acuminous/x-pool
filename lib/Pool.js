...
class Pool extends SafeEventEmitter {
  ...
  #commands() {
    ...
    return {
      create: new ResourceCommand(this, this.#config.factory.create.bind(this.#config.factory), this.#config.createTimeout, latch),
      destroy: new ResourceCommand(this, this.#config.factory.destroy.bind(this.#config.factory), this.#config.destroyTimeout, latch),
    }
  }
}
