...
module.exports = class Pool {
  ...
  #destroyOperation(resource) {
    return this.#managedResources.destroy(resource).then(() => {
      ...
      throw new XPoolError(Pool.Events.ERR_DESTROY_FAILED, 'Destroy failed. See cause for details', { cause });
    });
  }
  ...
  #checkShutdown() {
    ...
    this.#managedResources.destroyIdleResources().then(() => {
      ...
      const err = new XPoolError(Pool.Events.ERR_SHUTDOWN_FAILED, 'Shutdown failed. See cause for details', { cause });
