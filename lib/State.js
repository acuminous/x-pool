...
module.exports = class State {
  ...
  destroyingAcquiredResource(resource) {
    if (this._removeItem(this._acquiredResources, resource)) this._inProgressDestroyTasks.push(PLACEHOLDER);
  }

  commenceDestruction(task) {
    this._removeItem(this._inProgressDestroyTasks, PLACEHOLDER);
